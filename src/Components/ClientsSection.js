...
const clients = [
  ...
  { name: 'Expo 2020', logo: '/images/carrefour.png' },
  { name: 'GEMS Rewards', logo: '/images/nakheel.png' },
  { name: 'ITP Publishing', logo: '/images/mckin.png' },
  { name: 'McKinsey', logo: '/images/itehad.png' },
  { name: 'Carrefour', logo: '/images/emirates.png' },
  { name: 'Nakheel', logo: '/images/uae.png' },
